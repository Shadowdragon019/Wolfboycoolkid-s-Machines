...
public class IrininiumHoeItem extends WolfboycoolkidsMachinesModElements.ModElement {
	@ObjectHolder("wolfboycoolkids_machines:irininium_hoe")
	public static final Item block = null;
	public IrininiumHoeItem(WolfboycoolkidsMachinesModElements instance) {
		super(instance, 86);
	}
