...
public class IrininiumBlockBlock extends WolfboycoolkidsMachinesModElements.ModElement {
	@ObjectHolder("wolfboycoolkids_machines:irininium_block")
	public static final Block block = null;
	public IrininiumBlockBlock(WolfboycoolkidsMachinesModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("irininium_block");
		}
