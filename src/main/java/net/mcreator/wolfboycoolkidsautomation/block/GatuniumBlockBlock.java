...
public class GatuniumBlockBlock extends WolfboycoolkidsMachinesModElements.ModElement {
	@ObjectHolder("wolfboycoolkids_machines:gatunium_block")
	public static final Block block = null;
	public GatuniumBlockBlock(WolfboycoolkidsMachinesModElements instance) {
		super(instance, 63);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gatunium_block");
		}
